...
INIT_CKPT=${INIT_CKPT:-/workspace2/z_project/exp/nuplan/nuplan_whitenoise_diffusion_v1/source_overlap_3x100k_norm_20260517/checkpoints/epoch_0059.pth}

/workspace1/miniconda/envs/z_navsim_motdp/bin/torchrun \
  --nproc_per_node=2 \
  --master_port=29526 \
  /home/z/code/nuplan_whitenoise_diffusion_v1/training/train_nuplan.py \
  --config /home/z/code/nuplan_whitenoise_diffusion_v1/tmp/nuplan_diffusion_target_overlap_3x100k_norm_finetune_gpu67.yaml \
  --init_ckpt "$INIT_CKPT"