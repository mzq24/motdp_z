...
CONFIG_PATH=${CONFIG_PATH:-${REPO_ROOT}/tmp/nuplan_diffusion_source_overlap_3x100k_fixednorm_minlr1e-6_gpu4567_20260605.yaml}
LOG_ROOT=${LOG_ROOT:-/workspace2/z_project/exp/nuplan/nuplan_whitenoise_diffusion_v1/source_overlap_3x100k_fixednorm_final_lr1e-6_gpu4567_20260605/logs}
LOG_PATH="$LOG_ROOT/train_final_lr1e-6_gpu4567_$(date +%Y%m%d_%H%M%S).log"

mkdir -p "$LOG_ROOT"
echo "===== START diffusion source_overlap_3x100k_fixednorm_final_lr1e-6_gpu4567_20260605 ====="
