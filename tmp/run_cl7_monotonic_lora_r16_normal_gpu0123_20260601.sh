...
CONFIG_PATH=${CONFIG_PATH:-/home/z/code/nuplan_whitenoise_diffusion_v1/tmp/nuplan_diffusion_target_cl7_monotonic_norm_lora_r16_gpu0123_bs256_20260601.yaml}
LOG_ROOT=${LOG_ROOT:-/workspace2/z_project/exp/nuplan/nuplan_whitenoise_diffusion_v1/logs/lora_cl7_monotonic_r16_20260601}
LOG_PATH="$LOG_ROOT/normal_lora_rank16_gpu0123_$(date +%Y%m%d_%H%M%S).log"

mkdir -p "$LOG_ROOT"
echo "===== START cl7_monotonic_normal_lora_rank16 ====="
