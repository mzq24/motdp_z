...
LOG_ROOT=${LOG_ROOT:-/workspace2/z_project/exp/nuplan/nuplan_whitenoise_diffusion_v1/logs/queued_cl7_monotonic_r16_normal_pegp_20260601}
...
run_one \
  "cl7_monotonic_normal_adapter_rank16" \
  "/home/z/code/nuplan_whitenoise_diffusion_v1/tmp/nuplan_diffusion_target_cl7_monotonic_norm_adapter_r16_gpu4567_bs256_20260601.yaml" \
  "${MASTER_PORT_NORMAL:-29651}"

run_one \
  "cl7_monotonic_pegp_adapter_rank16" \
  "/home/z/code/nuplan_whitenoise_diffusion_v1/tmp/nuplan_diffusion_target_cl7_monotonic_pegp_adapter_r16_gpu4567_bs256_20260601.yaml" \
  "${MASTER_PORT_PEGP:-29652}"
