...
SEMANTIC_TEACHER_CHECKPOINT=${SEMANTIC_TEACHER_CHECKPOINT:-}
ALIGNMENT_CRITIC_CHECKPOINT_OVERRIDE=${ALIGNMENT_CRITIC_CHECKPOINT_OVERRIDE:-}
...
echo "  S_TEACHER:${SEMANTIC_TEACHER_CHECKPOINT:-<none>}"
echo "  A_CKPT:   ${ALIGNMENT_CRITIC_CHECKPOINT_OVERRIDE:-<none>}"
echo "  TIME:     $(date)"
echo "========================================"
