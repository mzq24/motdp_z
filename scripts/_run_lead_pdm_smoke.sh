...
python /home/z/code/navsim/navsim/planning/script/run_pdm_score_one_stage.py     train_test_split=navtrain     'train_test_split.scene_filter.max_scenes=8'     experiment_name=motdp_online_lead_smoke8     agent._target_=navsim_motdp.agents.online_lead_agent.OnlineLeadDiffusionAgent     +agent.checkpoint_path=/workspace2/z_project/motdp_logs/navsim_simple_official_lr1e4_e60_b64/best_model.pt     +agent.device=cuda:2     metric_cache_path=/workspace2/z_project/motdp_metric_cache_navtrain_smoke_64     worker=single_machine_thread_pool     worker.max_workers=1
echo DONE
