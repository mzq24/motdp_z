...
python /home/z/code/navsim/navsim/planning/script/run_pdm_score_one_stage.py     train_test_split=navtest     experiment_name=motdp_lead_navtest_full     agent._target_=navsim_motdp.agents.online_lead_agent.OnlineLeadDiffusionAgent     +agent.checkpoint_path=/workspace2/z_project/motdp_logs/navsim_simple_official_lr1e4_e60_b64/best_model.pt     +agent.device=cuda:0     metric_cache_path=/workspace2/data/navsim/processed_data/metric_cache_navtest     worker=single_machine_thread_pool     worker.max_workers=1
echo DONE
