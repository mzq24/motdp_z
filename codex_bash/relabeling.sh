...
# cover relation graph boundary postprocess
# python scripts/data_tools/postprocess_stage1_cover_relation_graph_boundary.py \
...
#   --output_path /workspace1/z_project/dataset/pdm_lite/tmp_data/full_scene_refresh/samples_packed.stage1_padded.relabel.tempocc_v2.chase.phaseobj.vbmin.graph.pkl \
#   --overwrite_existing
...
#   --input_path /workspace1/z_project/dataset/pdm_lite/tmp_data/full_scene_refresh/samples_packed.stage1_padded.relabel.tempocc_v2.chase.phaseobj.vbmin.graph.pkl \
#   --output_path /workspace1/z_project/dataset/pdm_lite/tmp_data/full_scene_refresh/samples_packed.stage1_padded.relabel.tempocc_v2.chase.phaseobj.vbmin.graph.consistency.pkl \
...
#   --padded_relabel /workspace1/z_project/dataset/pdm_lite/tmp_data/full_scene_refresh/samples_packed.stage1_padded.relabel.tempocc_v2.chase.phaseobj.vbmin.graph.consistency.pkl \
#   --output /workspace1/z_project/dataset/pdm_lite/tmp_data/full_scene_refresh/samples_packed.stage1_merged.tempocc_v2.chase.phaseobj.vbmin.graph.consistency.pkl \
#   --overwrite


# split train val again for holdout
# python scripts/data_tools/build_scene_holdout_split.py \
#   --packed-path /workspace1/z_project/dataset/pdm_lite/tmp_data/full_scene_refresh/samples_packed.stage1_merged.tempocc_v2.chase.phaseobj.vbmin.graph.consistency.pkl \
